...
const Slider = () => {
  ...
  const renderSlides = () =>
    slideImgs.map((item, index) => (
      <li
        key={index}
        className="slide-item w-[200px] h-full mx-[20px] flex bg-slate-300 shadow-xl shadow-gray-500 max-sm:w-[150px]"
      >
  ...
  return (
    <div className="slide w-full h-[400px] mt-[50px] py-[50px] overflow-x-hidden max-sm:h-[350px]">
      <ul
        ref={sliderRef}
